...
SpawnerImpl::SpawnerImpl(bool adaptive_): adaptive(adaptive_), regen(false), invisible(false), training(true), difficulty(10), status(1), gold(1), spawn(1), statusMultiplier(1), goldMultiplier(1), spawnMultiplier(1), health(1), armor(1) {}
